    ...
    return(
        ...
        {allBasket.map((item,index) => (
            <article className="BasketBlock" key={index}>
                ...
                <img src="https://i.postimg.cc/rprzgXC5/icons8-heart-48.png" className="BasketBtn" width="25px" onClick={() => AddItemfavorites(index)} height="25px" alt=""/>
        ...
        <article className="BasketBlock2">
            <button onClick={() => ModalOpen()} className="BasketBlock2_title">Оплатить</button>
        </article>
