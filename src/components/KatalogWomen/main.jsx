            ...
            <article className="KatalogSimilarBlock">
                ...
                {datesAll.tabsImgWomen.map((item,index) => (
                    <article className="KatalogSimilarBlock2" key={index}>
                        <Link to={`/katalog/Women/${index}`}><img className="KatalogSimilarImg" src={item.url} alt=""/></Link>
                        ...
                        <Link to={`/katalog/Women/${index}`} className="KatalogSimilarBtn"><button className="KatalogSimilarBtnA">Подробнее</button></Link>
